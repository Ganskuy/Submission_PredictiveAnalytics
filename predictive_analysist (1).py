...
Original file is located at
    https://colab.research.google.com/drive/1TBKQiDX8NuGU1Vf5vML5Ilyl4bagf54l
...
features = [f for f in numerical_features if f != 'Life expectancy']
...
for i, feature in enumerate(features, 1):
    ...
    sns.scatterplot(data=dia_clean, x=feature, y='Life expectancy', s=15)
    sns.regplot(data=dia_clean, x=feature, y='Life expectancy', scatter=False, color='red')
    plt.title(feature)
    plt.xlabel(feature)
